...
public class NoticeListFragment extends PolicyChildFragment {
    ...
    protected void loadData() {
        UserProvider.getNoticeList(mCurrentPage, new StringCallback() {
            ...
            public void onResponse(String response, int id) {
                refreshLayout.finishRefresh();
                refreshLayout.finishLoadMore();
                NoticeResponse1 mArticleResponse = new Gson().fromJson(response, NoticeResponse1.class);
                ...
                mDataList.addAll(mArticleResponse.getList());
                if (mCurrentPage == 1){
    ...
    class NoticeListAdapter extends BaseRecyclerAdapter<NoticeResponse1.ListBean>{
        ...
        @Override
        protected void fillData(BaseViewHolderHelper helper, int position, final NoticeResponse1.ListBean listBean) {
