...
public class SignupFragment4 extends BaseSignupFragment {
    ...
    private TypeResponse provinceTypeResponse = new TypeResponse();
    private TypeResponse mEstimateMiddle = new TypeResponse();
    private TypeResponse mArtsTypeResponse = new TypeResponse();
    private TypeResponse mEstimateMiddleHigh = new TypeResponse();
    private TypeResponse mInOrderTypeResponse = new TypeResponse();
